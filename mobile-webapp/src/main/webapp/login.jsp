  ...
  <style type="text/css">
    * {
    ...
    body {
      ...
      padding: 0;
      color: #fff;
      background: url('<%=request.getContextPath()%>/org.kie.wires.WiresShowcase/images/bg-login.png') repeat #1b1b1b;
      font-size: 14px;
    ...
    #dummy {
      ...
      height: 250px;
      width: 100%;
      background: url('<%=request.getContextPath()%>/org.kie.wires.WiresShowcase/images/bg-login-top.png') repeat #fff;
      z-index: 1;
    }
